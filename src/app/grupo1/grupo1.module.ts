...
@NgModule({
  declarations: [PagesComponent, ComponentsComponent, LoginClienteComponent, ListaLembretesComponent, CadastroClienteComponent, DadosClienteComponent, AreaClienteComponent, LembreteItemListaComponent, LembreteListaComponent,PlanosComponent, PortalComponent],
  imports: [
    CommonModule
  ]
})
